...
<div class="container py-4">
    <div class="row g-3">
        ...
        <!-- LEFT: only image slider (3 parts out of 4) -->
        <div class="col-lg-9">
            <div class="position-relative">
                <div class="left-slider sld">

                        @foreach ($data['slider'] as $items)

                    <div class="position-relative ">
                        <img src="{{ asset('storage/' . $items->image) }}" class=" object-fit-cover w-100 sld" alt="slide1"
                            style="height: 400px;">
                        <div
                            class="position-absolute top-0 start-0 h-100 d-flex flex-column justify-content-center p-4  bg-opacity-25 text-white">
                            <h2 class="fw-bold text-uppercase">{{ $items->title }}<br>{{ $items->description }}</h2>
                            <p>{{ $items->status }}</p>
                            <a href="{{ route('product.details',$items->id) }}"
                                class="btn btn-primary bg-xoom hover:bg-nex border-0 rounded-pill fw-bold px-4 w-auto">More Info </a>
                        </div>
                    </div>
                ...
                <div class="position-absolute bottom-0 end-0 m-3 d-flex gap-2">
                    <button
                        class="left-prev btn btn-primary bg-xoom rounded-circle border-xoom hover:bg-nex border-0">&#10094;</button>
                    <button
                        class="left-next btn btn-primary bg-xoom rounded-circle  border-xoom hover:bg-nex border-0 ">&#10095;</button>
                </div>
            </div>
        </div>

        <!-- RIGHT: just a static image blog -->
        <div class="col-lg-3">
            <img src="{{ asset('storage/' . $add->addImage) }}" class="img-fluid add rounded" alt="blog" style="height: 400px;">
...
<div class="container py-5">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center">
            <h1 class="fw-bold mb-0 me-4 fw-bold border-bottom border-2 border-nex pb-1 mb-0 text-nex">Best Sellers</h1>
            <span class="text-nex fs-5">Shop</span>
        </div>
    </div>
...
<! SHOP BY ROOM SECTION-->
    ...
    <section class="py-5 mt-">
        <div class="container">

            <!-- Heading -->
            <div class="mb-5" style="max-width:450px;">
                <h2 class="text-nex fw-bold border-bottom border-2 border-nex pb-1 mb-0">
                    Our Favorute Collection
                </h2>
                <p class="text-nex">
                    ...
                    <div class="col">
                        ...
                        <div class="border bg-white text-center h-100">
                            ...
                            <div class="p-3">
                                ...
                                <h6 class="lh-base text-nex mb-3">
                                    {{ $items->title }}
                                </h6>
